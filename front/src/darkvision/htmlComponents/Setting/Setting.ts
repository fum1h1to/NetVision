...
export class Setting {
  ...
  private setup() {
    const form = document.querySelector('#darkVision-form-setting') as HTMLFormElement;
  ...
  private getHTML(): string {
    ...
    return (
      ...
      <!-- Default Modal -->
      <div id="darkVision-settingModal" tabindex="-1"
